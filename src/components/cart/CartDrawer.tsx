          ...
          >
            ...
            <div className="flex-1 overflow-y-auto">
              {!isAuthenticated ? (
                ...
                /* Empty Cart */
                <div className="flex flex-col items-center justify-center h-full px-6 text-center">
                  <ShoppingBag className="w-16 h-16 text-elegant-base dark:text-elegant-base mb-4" />
                  <h3 className="text-lg font-cormorant font-semibold text-deep-black dark:text-ivory-white mb-2">
                    {t('cart.empty')}
                  </h3>
                  <p className="text-font-secondary dark:text-font-secondary-dark mb-6">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-sm font-cormorant font-semibold text-soft-gold mb-2">
                          {formatPrice(item.variant.price || Math.min(...item.product.variants.map(v => v.price)))}
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            disabled={isLoading}
                            className="w-6 h-6 rounded-full border border-elegant-base dark:border-elegant-base flex items-center justify-center hover:border-soft-gold dark:hover:border-bright-gold transition-colors disabled:opacity-50"
                          >
                            <Minus className="w-3 h-3" />
                          </button>
                          
                          <span className="text-sm font-josefin text-deep-black dark:text-ivory-white min-w-[2rem] text-center">
                            {item.quantity}
                          </span>
                      ...
                      <button
                        ...
                        disabled={isLoading}
                        className="p-2 text-font-secondary dark:text-font-secondary-dark hover:text-red-500 transition-colors disabled:opacity-50"
                      >
            ...
            {items.length > 0 && (
              <div className="border-t border-elegant-base dark:border-elegant-base p-6 space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xl font-cormorant font-bold text-soft-gold">
